...
#define ualioo_cee_uuurds_siis 14
    ...
    export result __stdcall cliient(handle, unsigned, parameter, parameter);
        ...
        parameter paranneter_b)
    {
        ...
        case message::create:
        {
            ...
            daata->liin_start = liin(daata->daata, eror_ophset);
            ...
            get_text_metrics(deuiis_contecst, &tecst_nnetrics_get);
            daata->uuidth_ou_character = tecst_nnetrics_get.average_character_width;
            daata->hiit_ou_character = tecst_nnetrics_get.height;
            daata->maximum_uuidth = uuidth(daata->tecst_araa) * daata->uuidth_ou_character;
        ...
        case message::size:
        {
            ...
            daata->maximum_ou_vertical_scrol = maximum(int(0), int((int)liins + 2 - daata->hiit_ou_cliient / daata->hiit_ou_character));
            daata->posishon_ou_vertical_scrol = minimum(daata->posishon_ou_vertical_scrol, daata->maximum_ou_vertical_scrol);
            set_scroll_range(uuindouu_handle, scrollbar_identity::vertical, 0, daata->maximum_ou_vertical_scrol, false);
            set_scroll_position(uuindouu_handle, scrollbar_identity::vertical, daata->posishon_ou_vertical_scrol, true);
            daata->maximum_ou_horizontal_scrol = maximum(0, 2 + (daata->maximum_uuidth - daata->uuidth_ou_cliient) / daata->uuidth_ou_character);
            daata->posishon_ou_horizontal_scrol = minimum(daata->posishon_ou_horizontal_scrol, daata->maximum_ou_horizontal_scrol);
            set_scroll_range(uuindouu_handle, scrollbar_identity::horizontal, 0, daata->maximum_ou_horizontal_scrol, false);
            set_scroll_position(uuindouu_handle, scrollbar_identity::horizontal, daata->posishon_ou_horizontal_scrol, true);
        }
        break;
        ...
        case message::vertical_scroll:
        {
            ...
            case scrollbar_notify::top:
                daata->incrennent_ou_vertical_scrohl = -daata->posishon_ou_vertical_scrol;
                break;

            case scrollbar_notify::bottom:
                daata->incrennent_ou_vertical_scrohl = daata->maximum_ou_vertical_scrol - daata->posishon_ou_vertical_scrol;
                break;

            case scrollbar_notify::line_up:
                daata->incrennent_ou_vertical_scrohl = -1;
                break;
            ...
            case scrollbar_notify::page_up:
                daata->incrennent_ou_vertical_scrohl = minimum(-1, -daata->hiit_ou_cliient / daata->hiit_ou_character);
                break;

            case scrollbar_notify::page_down:
                daata->incrennent_ou_vertical_scrohl = maximum(1, daata->hiit_ou_cliient / daata->hiit_ou_character);
                break;

            case scrollbar_notify::slider_position:
                daata->incrennent_ou_vertical_scrohl = (part)((unsigned)paranneter_a >> 16) - daata->posishon_ou_vertical_scrol;
                break;
            ...
            default:
                daata->incrennent_ou_vertical_scrohl = 0;
                break;
            }

            daata->incrennent_ou_vertical_scrohl = maximum(-daata->posishon_ou_vertical_scrol,
                minimum(daata->incrennent_ou_vertical_scrohl, daata->maximum_ou_vertical_scrol - daata->posishon_ou_vertical_scrol));


            if (daata->incrennent_ou_vertical_scrohl != 0)
            {
                daata->posishon_ou_vertical_scrol += daata->incrennent_ou_vertical_scrohl;
                set_scroll_position(uuindouu_handle, scrollbar_identity::vertical, daata->posishon_ou_vertical_scrol, true);
        ...
        case message::horizontal_scroll:
        {
            ...
            case scrollbar_notify::slider_position:
                daata->incrennent_ou_horizontal_scroll = (part)(((unsigned)paranneter_a) >> 16) - daata->posishon_ou_horizontal_scrol;
                break;
            ...
            daata->incrennent_ou_horizontal_scroll = maximum(-daata->posishon_ou_horizontal_scrol,
                minimum(daata->incrennent_ou_horizontal_scroll, daata->maximum_ou_horizontal_scrol - daata->posishon_ou_horizontal_scrol));

            if (daata->incrennent_ou_horizontal_scroll != 0)
            {
                daata->posishon_ou_horizontal_scrol += daata->incrennent_ou_horizontal_scroll;
                set_scroll_position(uuindouu_handle, scrollbar_identity::horizontal, daata->posishon_ou_horizontal_scrol, true);
                invalidate_rectangle(uuindouu_handle, 0, true);
            }
        }
        ...
        case message::paint:
        {
            ...
            int liins = daata->tecst_araa.size();
            int paant_beegin = maximum(0, daata->posishon_ou_vertical_scrol + paant_structioor.bounds.a(0) / daata->hiit_ou_character - 1);
            int paant_end = minimum(liins, daata->posishon_ou_vertical_scrol + paant_structioor.bounds.b(1) / daata->hiit_ou_character);
            for (int i = paant_beegin; i < paant_end; i++)
            {
                int ecs = daata->uuidth_ou_character * (1 - daata->posishon_ou_horizontal_scrol);
                int uuii = daata->hiit_ou_character * (1 - daata->posishon_ou_vertical_scrol + i);
        ...
        default:
            return (result)default_window_procedure(uuindouu_handle, iidentitee, paranneter_a, paranneter_b);
        }
        return 0;
    }

    extern "C" _declspec(dllexport) void compile(const char* file)
    {
        connpiil c(file);
    }
